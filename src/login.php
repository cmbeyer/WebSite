...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $response = HTTPRequester::HTTPGet('games3dcreations.ddns.net:8081' . '/api/v1/user/signIn', $data,$_POST['username'],$_POST['password']);
...
<body>
  ...
  <div class="login-card">
	...
	<div class="inputGroup inputGroup1">
		...
		<input type="Text" id="username" name="username" maxlength="254" placeholder="Username"/>

	</div>
	<div class="inputGroup inputGroup2">
		<label for="loginPassword" id="loginPasswordLabel"></label>
		<input type="password" name="password" id="password" placeholder="Password">
            <label id="showPasswordToggle" for="showPasswordCheck"><font color="black">Show Password</font>
			<input id="showPasswordCheck" type="checkbox"/>
			<div class="indicator"></div>
		</label>
	</div>
	<div class="inputGroup inputGroup3" align="center">
...
<?php include 'footer.php'; ?>
  ...
  <script src="https://static.codepen.io/assets/editor/full/full_page_renderer-392f30bac5515998abc08f3b58a826f5bbc52d9056f8629f01e754645c39110b.js"></script>
