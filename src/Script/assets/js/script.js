$(document).ready(function(){
    ...
    $("#fileup").change(function(){
		...
		$(document).on('click', '#readNow', function() {
			...
			xhr.open("GET", "/var/www/html/Media/Manga/Dragon_Ball_Super/Vol_1/"+comictitle); // make sure to put all the comics inside "comics" directory in the root directory
